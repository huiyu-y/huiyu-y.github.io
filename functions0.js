...
const playerperiodPlayer = new Vimeo.Player('playerperiod', options);

const playernuitPlayer = new Vimeo.Player('playernuit', options);

const playerlogoPlayer = new Vimeo.Player('playerlogo', options);
